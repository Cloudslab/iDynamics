# moe-longmix-stageB-scale45-replica5-linear-steps500-20260612T141947Z
...
## Result
- Implemented and exercised `WorkloadMixer` mode `linear` with 500 snapshots at 0.10s intervals.
...
## Key Metrics
- Mean edge Jaccard distance: 0.0038.
- Mean weighted edge distance: 0.0434.
- Mean hot-edge rank correlation: 0.9998.
- Mean request-mix entropy: 2.1812.
- Mean top-3 hotspot churn: 0.0010.
- Latency/SLA-pressure correlation: 0.1788.
