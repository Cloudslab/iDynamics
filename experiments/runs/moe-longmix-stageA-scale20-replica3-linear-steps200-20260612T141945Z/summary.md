# moe-longmix-stageA-scale20-replica3-linear-steps200-20260612T141945Z
...
## Result
- Implemented and exercised `WorkloadMixer` mode `linear` with 200 snapshots at 0.10s intervals.
...
## Key Metrics
- Mean edge Jaccard distance: 0.0052.
- Mean weighted edge distance: 0.0475.
- Mean hot-edge rank correlation: 0.9994.
- Mean request-mix entropy: 2.1795.
- Mean top-3 hotspot churn: 0.0025.
- Latency/SLA-pressure correlation: 0.2037.
