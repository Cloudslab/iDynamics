# moe-longmix-stageD-scale45-replica5-sinusoidal-steps1000-20260612T141957Z
...
## Result
- Implemented and exercised `WorkloadMixer` mode `sinusoidal` with 1000 snapshots at 0.10s intervals.
...
## Key Metrics
- Mean edge Jaccard distance: 0.0063.
- Mean weighted edge distance: 0.0423.
- Mean hot-edge rank correlation: 0.9999.
- Mean request-mix entropy: 2.9680.
- Mean top-3 hotspot churn: 0.0010.
- Latency/SLA-pressure correlation: 0.8388.
