# continuous-longmix-scale45-step-steps500-20260611T120732Z
...
## Result
- Implemented and exercised `WorkloadMixer` mode `step` with 500 snapshots at 5.00s intervals.
...
## Key Metrics
- Mean edge Jaccard distance: 0.0193.
- Mean weighted edge distance: 0.0491.
- Mean hot-edge rank correlation: 0.9946.
- Mean request-mix entropy: 1.1813.
- Mean top-3 hotspot churn: 0.0040.
- Latency/SLA-pressure correlation: 0.6359.
