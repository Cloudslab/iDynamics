# continuous-longmix-scale45-step-steps200-20260611T120728Z
...
## Result
- Implemented and exercised `WorkloadMixer` mode `step` with 200 snapshots at 5.00s intervals.
...
## Key Metrics
- Mean edge Jaccard distance: 0.0198.
- Mean weighted edge distance: 0.0517.
- Mean hot-edge rank correlation: 0.9864.
- Mean request-mix entropy: 1.1813.
- Mean top-3 hotspot churn: 0.0101.
- Latency/SLA-pressure correlation: 0.6746.
