# Standard Evaluation Summary: live-tc-validation-scale10-20260523T173852Z

Source run ledger: `experiments/runs/live-tc-validation-scale10-20260523T173852Z`

| Metric | Unit | tc-validation | Source |
| --- | --- | ---: | --- |
| `latency_p50_ms` | ms | 41.607 | `processed/tc_validation_metrics.json#during_mean_rtt_ms` |
| `latency_p95_ms` | ms | n/a | not measured |
| `latency_p99_ms` | ms | n/a | not measured |
| `throughput_rps` | requests/s | n/a | not measured |
| `sla_violations` | count | n/a | not measured |
| `sla_violation_rate` | ratio | n/a | not measured |
| `scheduler_decision_time_ms` | ms | n/a | not measured |
| `gda_build_time_ms` | ms | n/a | not measured |
| `ndm_injection_time_ms` | ms | 20.000 | `processed/tc_validation_metrics.json#target_one_way_delay_ms` |
| `cpu_overhead_pct` | percent | n/a | not measured |
| `memory_overhead_mb` | MiB | n/a | not measured |
| `migration_count` | count | n/a | not measured |
| `network_target_vs_measured_error` | unitless | 0.0865 | `processed/tc_validation_metrics.json#target_vs_measured_error_ms` |
