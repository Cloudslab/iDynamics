# Standard Evaluation Summary: live-tc-validation-scale45-20260523T174743Z

Source run ledger: `experiments/runs/live-tc-validation-scale45-20260523T174743Z`

| Metric | Unit | tc-validation | Source |
| --- | --- | ---: | --- |
| `latency_p50_ms` | ms | 41.290 | `processed/tc_validation_metrics.json#during_mean_rtt_ms` |
...
| `network_target_vs_measured_error` | unitless | 0.2896 | `processed/tc_validation_metrics.json#target_vs_measured_error_ms` |
