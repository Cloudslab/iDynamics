# online-boutique-longmix-stageA-scale20-replica3-markov-steps200-20260612T140708Z
...
## Result
- Implemented and exercised `WorkloadMixer` mode `markov` with 200 snapshots at 1.00s intervals.
...
## Key Metrics
- Mean edge Jaccard distance: 0.0596.
- Mean weighted edge distance: 0.1730.
- Mean hot-edge rank correlation: 0.7568.
- Mean request-mix entropy: 1.4354.
- Mean top-3 hotspot churn: 0.1693.
- Latency/SLA-pressure correlation: 0.7402.
