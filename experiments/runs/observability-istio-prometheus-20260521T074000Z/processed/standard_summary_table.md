# Standard Evaluation Summary: observability-istio-prometheus-20260521T074000Z

Source run ledger: `experiments/runs/observability-istio-prometheus-20260521T074000Z`

| Metric | Unit | run | Source |
| --- | --- | ---: | --- |
| `latency_p50_ms` | ms | n/a | not measured |
