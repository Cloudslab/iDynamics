# continuous-longmix-scale45-step-steps1000-20260611T120742Z
...
## Result
- Implemented and exercised `WorkloadMixer` mode `step` with 1000 snapshots at 5.00s intervals.
...
## Key Metrics
- Mean edge Jaccard distance: 0.0197.
- Mean weighted edge distance: 0.0483.
- Mean hot-edge rank correlation: 0.9973.
- Mean request-mix entropy: 1.1813.
- Mean top-3 hotspot churn: 0.0020.
- Latency/SLA-pressure correlation: 0.5930.
