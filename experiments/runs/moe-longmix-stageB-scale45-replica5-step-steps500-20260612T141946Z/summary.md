# moe-longmix-stageB-scale45-replica5-step-steps500-20260612T141946Z
...
## Result
- Implemented and exercised `WorkloadMixer` mode `step` with 500 snapshots at 0.10s intervals.
...
## Key Metrics
- Mean edge Jaccard distance: 0.0135.
- Mean weighted edge distance: 0.0518.
- Mean hot-edge rank correlation: 0.9945.
- Mean request-mix entropy: 1.6366.
- Mean top-3 hotspot churn: 0.0082.
- Latency/SLA-pressure correlation: 0.7020.
