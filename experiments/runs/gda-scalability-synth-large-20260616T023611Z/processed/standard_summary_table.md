# Standard Evaluation Summary: gda-scalability-synth-large-20260616T023611Z

Source run ledger: `experiments/runs/gda-scalability-synth-large-20260616T023611Z`
...
| `scheduler_decision_time_ms` | ms | 6.0425 | 24.744 | `raw/gda_overhead_repetitions.csv#graph_build_cpu_ms` |
| `gda_build_time_ms` | ms | 6.0470 | 24.749 | `raw/gda_overhead_repetitions.csv#graph_build_wall_ms` |
