# Standard Evaluation Summary: moe-serving-scale45-20260523T183126Z

Source run ledger: `experiments/runs/moe-serving-scale45-20260523T183126Z`

| Metric | Unit | kubernetes-default | policy2 | policy3 | policy4 | Source |
| --- | --- | ---: | ---: | ---: | ---: | --- |
| `latency_p50_ms` | ms | 27.990 | 24.360 | 24.091 | 24.379 | `raw/moe_expert_skew_timeseries.csv#default_latency_ms`; `raw/moe_expert_skew_timeseries.csv#policy2_latency_ms`; `raw/moe_expert_skew_timeseries.csv#policy3_latency_ms`; `raw/moe_expert_skew_timeseries.csv#policy4_latency_ms` |
| `latency_p95_ms` | ms | 29.456 | 25.918 | 25.686 | 25.884 | `raw/moe_expert_skew_timeseries.csv#default_latency_ms`; `raw/moe_expert_skew_timeseries.csv#policy2_latency_ms`; `raw/moe_expert_skew_timeseries.csv#policy3_latency_ms`; `raw/moe_expert_skew_timeseries.csv#policy4_latency_ms` |
| `latency_p99_ms` | ms | 29.984 | 26.391 | 25.937 | 26.372 | `raw/moe_expert_skew_timeseries.csv#default_latency_ms`; `raw/moe_expert_skew_timeseries.csv#policy2_latency_ms`; `raw/moe_expert_skew_timeseries.csv#policy3_latency_ms`; `raw/moe_expert_skew_timeseries.csv#policy4_latency_ms` |
