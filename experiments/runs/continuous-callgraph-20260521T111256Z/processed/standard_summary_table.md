# Standard Evaluation Summary: continuous-callgraph-20260521T111256Z

Source run ledger: `experiments/runs/continuous-callgraph-20260521T111256Z`

| Metric | Unit | workload-mixer | Source |
| --- | --- | ---: | --- |
| `latency_p50_ms` | ms | 88.089 | `raw/request_mix_timeseries.csv#latency_ms` |
| `latency_p95_ms` | ms | 98.079 | `raw/request_mix_timeseries.csv#latency_ms` |
| `latency_p99_ms` | ms | 100.28 | `raw/request_mix_timeseries.csv#latency_ms` |
