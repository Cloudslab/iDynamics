# continuous-longmix-scale45-markov-steps200-20260611T120731Z
...
## Result
- Implemented and exercised `WorkloadMixer` mode `markov` with 200 snapshots at 5.00s intervals.
...
## Key Metrics
- Mean edge Jaccard distance: 0.0613.
- Mean weighted edge distance: 0.1570.
- Mean hot-edge rank correlation: 0.8248.
