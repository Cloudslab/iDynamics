# Standard Evaluation Summary: gda-scalability-synth-20260523T181756Z

Source run ledger: `experiments/runs/gda-scalability-synth-20260523T181756Z`
...
| `scheduler_decision_time_ms` | ms | 5.5270 | 7.6365 | `raw/gda_overhead_repetitions.csv#graph_build_cpu_ms` |
| `gda_build_time_ms` | ms | 5.5296 | 7.6418 | `raw/gda_overhead_repetitions.csv#graph_build_wall_ms` |
| `ndm_injection_time_ms` | ms | n/a | n/a | not measured |
| `cpu_overhead_pct` | percent | n/a | n/a | not measured |
| `memory_overhead_mb` | MiB | 0.0001 | 0.7188 | `raw/gda_overhead_repetitions.csv#peak_python_memory_mib` |
