"""Import-safe placeholder for legacy controller cluster utilities."""

from iDynamicsPackagesModules._unsupported import raise_external_configuration_required


def require_explicit_cluster_configuration(operation: str = "controller cluster utility") -> None:
