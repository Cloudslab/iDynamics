...
ONLINE_BOUTIQUE = BenchmarkAdapter(
    ...
    license="Apache-2.0",
    local_path="external/benchmarks/online-boutique",
    manifest_paths=(
        "external/benchmarks/online-boutique/kubernetes-manifests",
        "external/benchmarks/online-boutique/istio-manifests",
    ),
    service_count=12,
    ...
    workload_generators=(
        WorkloadGeneratorSpec(
            ...
            source_path="external/benchmarks/online-boutique/src/loadgenerator/locustfile.py",
    ...
    selection_notes="Best primary candidate: Kubernetes-native, actively maintained, compact enough for constrained smoke runs, and rich in gRPC edges for Istio telemetry.",
)
...
DEATHSTAR_HOTEL = BenchmarkAdapter(
    ...
    license="Apache-2.0",
    local_path="external/benchmarks/deathstarbench",
    manifest_paths=("external/benchmarks/deathstarbench/hotelReservation/kubernetes",),
    service_count=19,
    ...
    workload_generators=(
        WorkloadGeneratorSpec(
            name="wrk2-mixed",
            tool="wrk2",
            source_path="external/benchmarks/deathstarbench/hotelReservation/wrk2/scripts/hotel-reservation/mixed-workload_type_1.lua",
    ...
    known_risks=(
        "Kubernetes manifests were generated by Kompose and include host-path style persistent-volume assumptions.",
...
DEATHSTAR_MEDIA = BenchmarkAdapter(
    ...
    license="Apache-2.0",
    local_path="external/benchmarks/deathstarbench",
    manifest_paths=("external/benchmarks/deathstarbench/mediaMicroservices/openshift",),
    service_count=33,
    application_services=(
        "cast-info-service",
    ...
    workload_generators=(
        WorkloadGeneratorSpec(
            ...
            tool="wrk2",
            source_path="external/benchmarks/deathstarbench/mediaMicroservices/wrk2/scripts/media-microservices/compose-review.lua",
    ...
    known_risks=(
        ...
        "Larger stateful footprint makes it a poor first target for fast small-worker smoke runs.",
...
DEATHSTAR_SOCIAL_NETWORK = BenchmarkAdapter(
    ...
    source_commit="6ecb09706140f8730b5385c08f1386c654c3c526",
    license="Apache-2.0",
    local_path="external/benchmarks/deathstarbench/socialNetwork",
    manifest_paths=("external/benchmarks/deathstarbench/socialNetwork/helm-chart/socialnetwork",),
    service_count=28,
    application_services=(
        "nginx-thrift",
    ...
    workload_generators=(
        WorkloadGeneratorSpec(
            ...
            source_path="external/benchmarks/deathstarbench/socialNetwork/wrk2/scripts/social-network/mixed-workload.lua",
...
TRAIN_TICKET = BenchmarkAdapter(
    ...
    license="Apache-2.0",
    local_path="external/benchmarks/train-ticket",
    manifest_paths=("external/benchmarks/train-ticket/deployment/kubernetes-manifests/k8s-with-istio",),
    service_count=64,
    application_services=(
    ...
    workload_generators=(
        WorkloadGeneratorSpec(
            ...
            source_path="external/benchmarks/train-ticket/ts-gateway-service/src/main/resources/application.yml",
            command_template="curl -fsS http://{gateway_host}:{gateway_port}/",
...
SOCK_SHOP = BenchmarkAdapter(
    ...
    license="Apache-2.0",
    local_path="external/benchmarks/sock-shop",
    manifest_paths=(
        "external/benchmarks/sock-shop/deploy/kubernetes/manifests",
        "external/benchmarks/sock-shop/deploy/kubernetes/manifests-loadtest",
    ),
    service_count=14,
    ...
    workload_generators=(
        WorkloadGeneratorSpec(
            ...
            tool="Locust",
            source_path="external/benchmarks/sock-shop/deploy/kubernetes/manifests-loadtest/loadtest-dep.yaml",
    ...
    selection_notes="Compatibility baseline only; do not lead paper claims with this benchmark.",
)
