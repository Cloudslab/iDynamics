#!/usr/bin/env python3
"""Run iDynamics Policy 1-4 placement planners from JSON or built-in MoE data."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--policy", choices=["policy1", "policy2", "policy3", "policy4"], required=True)
    parser.add_argument("--input", type=Path, help="JSON file with pods, nodes, service_graph, and optional network")
    parser.add_argument("--output", type=Path, help="Write placement plan JSON")
